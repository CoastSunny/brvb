function renorm_batch(wh, ico, mo, o, NSR, varargin)
...
%     SGE = 1;
    if sim
%         cfg = renorm_simulate3(wh.orig.vertices, ico(o).wh.faces, ico(o), false, limsup, liminf, smear);
        cfg = renorm_simulate_orig(wh.orig.vertices, wh.orig.faces, wh.cfg, false, limsup, liminf);
        X = cfg.rpot;
    else
